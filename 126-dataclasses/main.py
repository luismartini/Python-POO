'''
O que são as dataclasses? O módulo Dataclasses fornece um decorador e funções para criar automaticamente métodos, como __init__(), __repr__(), __eq__() em classes definidas pelo usuário.
